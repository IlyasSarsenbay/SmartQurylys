...
@Component({
  ...
  template: `
    <div class="admin-edit-container" *ngIf="userEditForm">
      ...
      <form [formGroup]="userEditForm" (ngSubmit)="onSubmit()">
        ...
        <div class="form-group">
            ...
            <input id="organization" formControlName="organization" class="form-input" [placeholder]="userEditForm.get('organization')?.value ? '' : 'Организация отсутствует'">
        </div>
