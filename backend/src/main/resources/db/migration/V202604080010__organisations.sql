...
VALUES
(36, 'Гражданское строительство', 'г. Алматы, пр. Абая 15', 'Главный инженер', 'CONTRACTOR', 10, NULL),
(17, 'Строительство', 'г. Алматы, ул. Абая, 100', 'Исполнительный директор', 'CONTRACTOR', 20, NULL),
(39, 'dr', 'syfa', 'dre', 'CUSTOMER', 3, 'AVAILABLE')
