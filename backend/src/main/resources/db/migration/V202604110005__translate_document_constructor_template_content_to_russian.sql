...
SET
    schema_json = $$[
      {"key":"parties","title":"Стороны","description":"Проверьте юридические стороны договора и их представителей.","fields":[
        ...
        {"key":"customerCompany","label":"Компания заказчика","type":"text","required":true,"placeholder":"ТОО SmartQurylys Development","helperText":"Полное юридическое наименование заказчика.","validation":{"minLength":3,"maxLength":120}},
        {"key":"customerAddress","label":"Адрес заказчика","type":"text","required":true,"placeholder":"проспект Абылай Хана, 16, Алматы, Казахстан","helperText":"Юридический или основной адрес деятельности заказчика.","validation":{"minLength":10,"maxLength":180}},
        {"key":"customerRepresentative","label":"Представитель заказчика","type":"text","required":true,"placeholder":"Айдар Сарсембаев","helperText":"Уполномоченный представитель заказчика.","validation":{"minLength":3,"maxLength":80}},
        {"key":"contractorCompany","label":"Компания исполнителя","type":"text","required":true,"placeholder":"ТОО BuildTech Engineering","helperText":"Полное юридическое наименование исполнителя.","validation":{"minLength":3,"maxLength":120}},
        {"key":"contractorAddress","label":"Адрес исполнителя","type":"text","required":true,"placeholder":"улица Сатпаева, 25, Алматы, Казахстан","helperText":"Юридический или основной адрес деятельности исполнителя.","validation":{"minLength":10,"maxLength":180}},
        {"key":"contractorRepresentative","label":"Представитель исполнителя","type":"text","required":true,"placeholder":"Арман Алиев","helperText":"Уполномоченный представитель исполнителя.","validation":{"minLength":3,"maxLength":80}}
      ]},
      {"key":"scope","title":"Предмет и объём услуг","description":"Опишите услуги в деловой форме без переписывания договора вручную.","fields":[
        {"key":"projectName","label":"Название проекта","type":"text","required":true,"placeholder":"Модернизация фасада бизнес-центра","helperText":"Коммерческое наименование проекта.","validation":{"minLength":4,"maxLength":120}},
        {"key":"serviceDescription","label":"Перечень услуг","type":"text","required":true,"placeholder":"Разработка рабочей документации, авторский надзор, контроль качества и ежемесячная отчётность по фасадным и отделочным работам.","helperText":"Краткое и понятное описание услуг.","validation":{"minLength":30,"maxLength":500}},
        {"key":"deliverables","label":"Основные результаты","type":"text","required":true,"placeholder":"Утверждённые чертежи, еженедельные акты осмотра, ежемесячные отчёты о ходе работ и итоговый комплект исполнительной документации.","helperText":"Что именно получает заказчик.","validation":{"minLength":20,"maxLength":300}},
        {"key":"serviceLocation","label":"Место оказания услуг","type":"text","required":true,"placeholder":"Алматы, Казахстан","helperText":"Локация, где оказываются или координируются услуги.","validation":{"minLength":3,"maxLength":120}}
      ]},
