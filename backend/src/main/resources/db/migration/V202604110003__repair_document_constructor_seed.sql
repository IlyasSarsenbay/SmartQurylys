...
VALUES (
    ...
    TRUE,
    $$[
      {"key":"parties","title":"Parties","description":"Confirm the legal parties and their representatives.","fields":[
      ...
      {"key":"scope","title":"Scope of work","description":"Describe the service in business terms without rewriting the agreement.","fields":[
      ...
      {"key":"dates","title":"Dates and term","description":"Set the commercial schedule and review period.","fields":[
      ...
      {"key":"payment","title":"Payment and amounts","description":"Use structured payment controls with standard defaults.","fields":[
      ...
      {"key":"optionalClauses","title":"Optional clauses","description":"Turn standard legal clauses on or off.","fields":[
      ...
      {"key":"signatories","title":"Signatory details","description":"These values are inserted directly into the signature block.","fields":[
