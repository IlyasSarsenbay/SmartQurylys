...
CREATE TABLE public.activity_logs (
    ...
    CONSTRAINT activity_logs_action_type_check CHECK (((action_type)::text = ANY (ARRAY[('REQUEST_ACCEPTANCE'::character varying)::text, ('ACCEPTED_ACCEPTANCE'::character varying)::text, ('REJECTED_ACCEPTANCE'::character varying)::text, ('PROJECT_UPDATED'::character varying)::text, ('STAGE_UPDATED'::character varying)::text, ('STAGE_DELETED'::character varying)::text, ('FILE_ADDED'::character varying)::text, ('FILE_DELETED'::character varying)::text]))),
    CONSTRAINT activity_logs_entity_type_check CHECK (((entity_type)::text = ANY (ARRAY[('PROJECT'::character varying)::text, ('STAGE'::character varying)::text, ('FILE'::character varying)::text, ('LICENSE'::character varying)::text])))
);
...
CREATE TABLE public.chat_messages (
    ...
    CONSTRAINT chat_messages_acknowledgement_status_check CHECK (((acknowledgement_status)::text = ANY (ARRAY[('PENDING'::character varying)::text, ('ACKNOWLEDGED'::character varying)::text]))),
    CONSTRAINT chat_messages_coordination_status_check CHECK (((coordination_status)::text = ANY (ARRAY[('PENDING'::character varying)::text, ('APPROVED'::character varying)::text, ('REJECTED'::character varying)::text]))),
    CONSTRAINT chat_messages_message_type_check CHECK (((message_type)::text = ANY (ARRAY[('TEXT'::character varying)::text, ('ATTACHMENT'::character varying)::text, ('MENTION'::character varying)::text, ('COORDINATION_REQUEST'::character varying)::text, ('ACKNOWLEDGEMENT_REQUEST'::character varying)::text, ('COORDINATION_RESPONSE'::character varying)::text, ('ACKNOWLEDGEMENT_RESPONSE'::character varying)::text, ('SYSTEM_ACTION'::character varying)::text])))
);
...
CREATE TABLE public.conversations (
    ...
    project_id bigint,
    CONSTRAINT conversations_type_check CHECK (((type)::text = ANY (ARRAY[('PROJECT_CHAT'::character varying)::text, ('PRIVATE_CHAT'::character varying)::text])))
);
...
CREATE TABLE public.documents (
    ...
    CONSTRAINT documents_status_check CHECK (((status)::text = ANY (ARRAY[('WAITING'::character varying)::text, ('CREATION'::character varying)::text, ('APPROVAL'::character varying)::text, ('SIGNATURE'::character varying)::text, ('REGISTRATION'::character varying)::text, ('IN_PROGRESS'::character varying)::text, ('COMPLETED'::character varying)::text])))
);
...
CREATE TABLE public.licenses (
    ...
    CONSTRAINT licenses_review_status_check CHECK (((review_status)::text = ANY (ARRAY[('PENDING_REVIEW'::character varying)::text, ('APPROVED'::character varying)::text, ('REJECTED'::character varying)::text])))
);
...
CREATE TABLE public.notifications (
    ...
    sender_id bigint,
    CONSTRAINT notifications_type_check CHECK (((type)::text = ANY (ARRAY[('INVITATION'::character varying)::text, ('PROJECT_UPDATE'::character varying)::text, ('FILE_UPLOAD'::character varying)::text, ('TASK_ASSIGNMENT'::character varying)::text, ('MENTION'::character varying)::text, ('STAGE_REACTIVATION'::character varying)::text, ('LICENSE_APPROVED'::character varying)::text, ('LICENSE_REJECTED'::character varying)::text])))
);
...
CREATE TABLE public.organisation_specializations (
    ...
    CONSTRAINT organisation_specializations_specialization_check CHECK (((specialization)::text = ANY (ARRAY[('EARTHWORKS'::character varying)::text, ('FOUNDATION_WORKS'::character varying)::text, ('ROOFING_WORKS'::character varying)::text, ('DEMOLITION_WORKS'::character varying)::text, ('TURNKEY_COTTAGE_AND_VILLA_CONSTRUCTION'::character varying)::text, ('ELECTRICAL_INSTALLATION'::character varying)::text, ('PLUMBING_AND_SEWERAGE'::character varying)::text, ('VENTILATION_AND_AIR_CONDITIONING'::character varying)::text, ('PLASTERING_AND_PAINTING_WORKS'::character varying)::text, ('TILE_LAYING'::character varying)::text, ('LAMINATE_AND_PARQUET_LAYING'::character varying)::text, ('INTERIOR_FINISHING_WORKS'::character varying)::text, ('HIGH_QUALITY_FINE_FINISHING'::character varying)::text, ('HEATING_SYSTEM_INSTALLATION'::character varying)::text, ('LOW_CURRENT_SYSTEMS_INSTALLATION'::character varying)::text, ('FIRE_SAFETY_SYSTEM_INSTALLATION'::character varying)::text, ('WATERPROOFING_WORKS'::character varying)::text, ('INSTALLATION_OF_WINDOWS_DOORS_AND_PARTITIONS'::character varying)::text, ('LANDSCAPING_AND_GREENING_OF_THE_TERRITORY'::character varying)::text, ('ASPHALTING_OF_ROADS_AND_TERRITORIES'::character varying)::text, ('INSTALLATION_OF_CURBS_AND_ROAD_BARRIERS'::character varying)::text])))
);
...
CREATE TABLE public.organisations (
    ...
    id bigint NOT NULL,
    status character varying(255),
    CONSTRAINT organisations_specialization_check CHECK (((specialization)::text = ANY (ARRAY[('EARTHWORKS'::character varying)::text, ('FOUNDATION_WORKS'::character varying)::text, ('ROOFING_WORKS'::character varying)::text, ('DEMOLITION_WORKS'::character varying)::text, ('TURNKEY_COTTAGE_AND_VILLA_CONSTRUCTION'::character varying)::text, ('ELECTRICAL_INSTALLATION'::character varying)::text, ('PLUMBING_AND_SEWERAGE'::character varying)::text, ('VENTILATION_AND_AIR_CONDITIONING'::character varying)::text, ('PLASTERING_AND_PAINTING_WORKS'::character varying)::text, ('TILE_LAYING'::character varying)::text, ('LAMINATE_AND_PARQUET_LAYING'::character varying)::text, ('INTERIOR_FINISHING_WORKS'::character varying)::text, ('HIGH_QUALITY_FINE_FINISHING'::character varying)::text, ('HEATING_SYSTEM_INSTALLATION'::character varying)::text, ('LOW_CURRENT_SYSTEMS_INSTALLATION'::character varying)::text, ('FIRE_SAFETY_SYSTEM_INSTALLATION'::character varying)::text, ('WATERPROOFING_WORKS'::character varying)::text, ('INSTALLATION_OF_WINDOWS_DOORS_AND_PARTITIONS'::character varying)::text, ('LANDSCAPING_AND_GREENING_OF_THE_TERRITORY'::character varying)::text, ('ASPHALTING_OF_ROADS_AND_TERRITORIES'::character varying)::text, ('INSTALLATION_OF_CURBS_AND_ROAD_BARRIERS'::character varying)::text]))),
    CONSTRAINT organisations_status_check CHECK (((status)::text = ANY (ARRAY[('AVAILABLE'::character varying)::text, ('BUSY'::character varying)::text]))),
    CONSTRAINT organisations_type_check CHECK (((type)::text = ANY (ARRAY[('CUSTOMER'::character varying)::text, ('CONTRACTOR'::character varying)::text, ('AUTHOR_SUPERVISON'::character varying)::text, ('TECHNICAL_SUPERVISON'::character varying)::text, ('SUPPLIER'::character varying)::text])))
);
...
CREATE TABLE public.projects (
    ...
    city_id bigint,
    user_id bigint,
    CONSTRAINT projects_status_check CHECK (((status)::text = ANY (ARRAY[('DRAFT'::character varying)::text, ('WAITING'::character varying)::text, ('ACTIVE'::character varying)::text, ('ON_PAUSE'::character varying)::text, ('COMPLETED'::character varying)::text, ('CANCELLED'::character varying)::text])))
);
...
CREATE TABLE public.stages (
    ...
    status character varying(255),
    schedule_id bigint,
    CONSTRAINT stages_status_check CHECK (((status)::text = ANY (ARRAY[('WAITING'::character varying)::text, ('ACTIVE'::character varying)::text, ('ON_PAUSE'::character varying)::text, ('COMPLETED'::character varying)::text])))
);
...
107	PROJECT_UPDATED	admin	23	test	PROJECT	2026-02-17 12:24:17.144575	18	23
108	FILE_ADDED	Кудиярхан Айбар	117	chill (1).jpg	PROJECT	2026-02-25 11:54:19.010255	41	26
109	FILE_ADDED	Кудиярхан Айбар	118	Syllabus Presentation Skills Course (1).docx	PROJECT	2026-02-25 12:31:52.238856	41	26
110	PROJECT_UPDATED	admin	18	Обновленное имя	PROJECT	2026-03-05 09:45:15.512291	18	18
111	FILE_ADDED	admin	119	Шаблон типового меморандума КБТУ.docx	PROJECT	2026-03-05 09:49:03.030725	18	24
\.
...
54	\N	Здравствуйте коллеги	\N	TEXT	\N	2026-02-10 14:13:28.525514	\N	9	\N	18
55	\N	Добрый день коллеги	\N	TEXT	\N	2026-02-10 14:25:04.346599	\N	10	\N	18
56	\N	Salam	\N	TEXT	\N	2026-02-17 12:03:19.781788	\N	11	\N	41
57	\N	Hi	\N	TEXT	\N	2026-02-17 12:04:41.084225	\N	12	\N	41
58	\N	@Ilyas Sarsenbai 	\N	TEXT	\N	2026-02-17 12:06:26.966151	\N	12	\N	41
59	\N	Hallo	\N	TEXT	\N	2026-02-17 12:06:59.280968	\N	13	\N	41
60	\N	@Ilyas 	\N	TEXT	\N	2026-02-17 12:07:30.903129	\N	13	\N	41
61	\N	f	PENDING	COORDINATION_REQUEST	\N	2026-02-19 13:39:57.711902	\N	13	\N	41
62	\N		\N	TEXT	\N	2026-02-19 15:37:27.096639	116	11	\N	41
\.
...
9	2026-02-10 14:13:28.525514	Чат проекта: ЖК ЭКО град	PROJECT_CHAT	24
10	2026-02-10 14:25:04.346599	Чат проекта: ЖК ЭКО град	PROJECT_CHAT	25
12	2026-02-17 12:06:26.966151	Кудиярхан Айбар & Ilyas Sarsenbai	PRIVATE_CHAT	\N
13	2026-02-19 13:39:57.711902	Ilyas & Кудиярхан Айбар	PRIVATE_CHAT	\N
11	2026-02-19 15:37:27.096639	Кудиярхан Айбар & Test User2	PRIVATE_CHAT	\N
14	2026-02-25 12:00:51.145174	Чат проекта: Тест1	PROJECT_CHAT	26
\.
...
116	\N	2026-02-19 15:37:27.092199	uploads/temp_1771515447086_c879db39-556f-4f8b-93cc-9c9b009a06f8.jpg	chill.jpg	509813	41	\N	\N	\N	\N	FILE
117	26	2026-02-25 11:54:19.000826	uploads/temp_1772020459000_13a12ae1-a8d6-425e-8fc8-165fd4ab7287.jpg	chill (1).jpg	509813	41	\N	\N	\N	\N	FILE
118	26	2026-02-25 12:31:52.231899	uploads/temp_1772022712231_f57dff1b-4203-4863-b824-e8005f535bd7.docx	Syllabus Presentation Skills Course (1).docx	54199	41	\N	\N	\N	\N	FILE
119	24	2026-03-05 09:49:03.018154	uploads/temp_1772704143017_9c058db2-002d-4e1a-b9f7-f29d60be9a7a.docx	Шаблон типового меморандума КБТУ.docx	29265	18	\N	\N	\N	\N	FILE
\.
...
48	2026-02-10 14:11:27.082172	f	admin (БИН 111111111199) приглашает вас принять участие в проекте ЖК ЭКО град в качестве подрядчик	39	INVITATION	24	40	18
49	2026-02-17 12:06:26.961087	f	Кудиярхан Айбар отметил вас в чате: Кудиярхан Айбар & Ilyas Sarsenbai	12	MENTION	\N	11	41
51	2026-02-25 11:54:01.208437	f	Кудиярхан Айбар (БИН 123456789010) приглашает вас принять участие в проекте Тест1 в качестве Подрядчик	40	INVITATION	26	17	41
\.
...
39	f	t	t	2026-02-10 14:11:27.075564	2026-02-13 14:11:27.07558	подрядчик	24	40	18
40	f	t	t	2026-02-25 11:54:01.199291	2026-02-28 11:54:01.199296	Подрядчик	26	17	41
\.
...
7	test	2026-02-04 12:48:49.919594	13	18
\.
...
24	проект тест	2027-02-10	ЖК ЭКО град	2026-02-10	DRAFT	ЖК	30	18
25	Описание проекта	2028-02-10	ЖК ЭКО град	2026-02-10	DRAFT	ЖК	1	18
23	test	2026-02-28	test	2026-02-03	WAITING	test	22	17
26	Тестовое описание	2026-04-23	Тест1	2026-02-25	DRAFT	Реконструкция	18	41
\.
...
22	2026-02-10 14:11:08.693956	ГПР	24
23	2026-02-10 14:23:09.493806	ГПР	25
24	2026-02-25 11:53:14.202355	ГПР	26
\.
...
36	\N	описание	2026-01-12	начало	\N	2026-01-10	COMPLETED	22
37	\N	Строительные работы	2026-12-13	1 этап	\N	2026-10-12	COMPLETED	23
38	\N	Монтажные работы	2026-02-18	2 этап	\N	2026-02-15	COMPLETED	23
39	\N	Сдача в эксплуатацию	2026-02-20	3 этап	\N	2026-02-19	ACTIVE	23
40	\N	Построить фундамент	2026-03-12	Этап 1	\N	2026-02-25	ACTIVE	24
\.
...
68	1	2026-02-26	f	f	\N	t	Задача 1	2026-02-25	\N	40
\.
...
13	i_sarsenbay@kbtu.kz	Ilyas	111111111198	TestOrg	$2a$10$X.04enEdh/IBXOZYnBPLgOqA7IXzTpwOCc7Xevg/Y/me2GI4m9W1S	+77011230023	48	USER	USER
40	seitkasymovlaw@gmail.com	Сейткасымов Алмат Қамбарұлы	030621501321	\N	$2a$10$mJxQAipiib1mTjCaPTMhv..1SREoH5emcyqzqeGN2uECaE35nGHNC	87076111537	1	USER	USER
41	aibarkydiarxan@gmail.com	Кудиярхан Айбар	123456789010	\N	$2a$10$iMHA2sMvy2rxeUWTZvNd/O71dQLi1v2GdCmTQqWuhRErsm1LCiskm	+77788848333	1	USER	ADMIN
\.
...
SELECT pg_catalog.setval('public.email_verification_id_seq', 100, true);
...
SELECT pg_catalog.setval('public.files_id_seq', 119, true);
...
SELECT pg_catalog.setval('public.participant_invitations_id_seq', 40, true);
...
SELECT pg_catalog.setval('public.project_notes_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.schedules_id_seq', 24, true);
